...
import {ClientLayoutEvents} from "../client/events/client-layout.events";
...
export class AdminLayoutComponent extends AppBaseSmartComponent<ClientLayoutEvents> implements OnInit, AfterViewInit, OnDestroy {
